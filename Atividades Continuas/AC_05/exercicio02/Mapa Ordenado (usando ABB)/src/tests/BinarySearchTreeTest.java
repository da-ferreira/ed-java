...
import mapa_ordenado_abb.BinarySearchTree;
...
class BinarySearchTreeTest {
	...
	void test() {
		...
		System.out.println("Uso da impressão parentizada de uma árvore binária de busca para visualizar sua estrutura após as inserções e remoções");
		System.out.println("========================================");
