...
import mapa_ordenado_avl.AVLTreeMap;
...
class AVLTreeMapTest {
	...
	void test() {
		...
		System.out.println("Uso da impressão parentizada de uma árvore AVL para visualizar que ela fica balanceada após as inserções e remoções\n");
		System.out.println("========================================");
