...
public class CircularLinkedList {
	...
	public void add(Node newElement) {
		if (size == 0) {
			...
			/*
			 * Insere um elemento logo apos o cursor:
	...
	public Node remove() {
		 ...
		 * 1. Verifica se o cursor eh o unico elemento da lista,
		 *    se for, coloca ele como null (a lista fica vazia).
		 * 2. Caso contrario, liga o cursor com o elemento depois do pr�ximo do cursor, ou seja,
