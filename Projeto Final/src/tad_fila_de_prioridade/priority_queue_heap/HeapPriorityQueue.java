...
package tad_fila_de_prioridade.priority_queue_heap;

import java.util.Comparator;

import tad_fila_de_prioridade.commons.DefaultComparator;
import tad_fila_de_prioridade.commons.Entry;
import tad_fila_de_prioridade.commons.PriorityQueue;
import tad_fila_de_prioridade.complete_binary_tree.ArrayListCompleteBinaryTree;
import tad_fila_de_prioridade.exceptions.EmptyPriorityQueueException;
import tad_fila_de_prioridade.exceptions.InvalidKeyException;
import tad_fila_de_prioridade.position.Position;
...
public class HeapPriorityQueue<Key, Value> implements PriorityQueue<Key, Value> {
	...
	@Override
	public String toString() {
		String format = heap.toString();
		
		if (! heap.isEmpty())
			return format.substring(7, format.length());
