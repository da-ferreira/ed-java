...
public class CircularLinkedList {
    protected Node cursor;  // cursor (uma esp�cie de cabe�a da lista).
	protected Long size;
	...
	public void add(Node newElement) {
		if (size == 0) {
			...
			/*
			 * Insere um elemento logo ap�s o cursor:
	...
	public Node remove() {
		 ...
		 * 1. Verifica se o cursor � o unico elemento da lista,
		 *    se for, coloca ele como null (a lista fica vazia).
		 * 2. Caso contr�rio, liga o cursor com o elemento depois do pr�ximo do cursor, ou seja,
